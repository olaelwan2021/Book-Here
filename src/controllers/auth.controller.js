...
const message = `
  <div style="font-family: Arial, sans-serif; max-width: 600px;">
    ...
    <div style="background: #f5f5f5; padding: 15px; border-radius: 5px; text-align: center; font-size: 18px; font-weight: bold; letter-spacing: 2px; margin: 20px 0;">
      ${resetToken}
    </div>
...
export const resetPassword = async (req, res) => {
  ...
  if (!code || !password) {
    throw new CustomError("Code and new password are required", 400);
  }
