            ...
            <div className="home-body">
                ...
                <section id="hero" className="home-hero-section mt-0" style={{ paddingTop: "80px", paddingBottom: "80px" }}>
                    <div className="home-container">
                        ...
                        <p>Book Here Hotel offers exceptional accommodation that combines comfort, luxury, and premium service in the heart of the city.</p>
                    ...
                    <div className="home-container">
                        <div className="about-content">
                            <div className="about-text">
                                <h2 className="section-title">Welcome to Book Here</h2>
                ...
                <section id="rooms" className="bg-white" style={{ paddingTop: "80px", paddingBottom: "80px" }}>
                    <div className="home-container">
                        <h2 className="section-title text-center">Our Top Rated Rooms & Suites</h2>
                            ...
                            {listRooms.map((room) => (
                                <div className="room-card" key={room._id}>
                                    ...
                                    <div className="room-card-body">
                                        ...
                                        <p style={{ height: "3.2rem" }}>{room.description}</p>
                        ...
                        <div className="text-center mt-4">
                            ...
                            >
                                See More Rooms <ArrowRight size={20} />
                            </button>
                        </div>
                    </div>
                </section>
                    ...
                    <div className="home-container">
                        ...
                        <div className="services-grid">
                            <div className="feature-box">
                                <div className="feature-icon text-color-dark">
                ...
                <section className="bg-white" style={{ paddingTop: "80px", paddingBottom: "80px" }}>
                    <div className="home-container">
                        ...
                        <div className="testimonials-grid">
                            ...
                            <div className="testimonial-card">
                                <div className="testimonial-text">
                                    "The attention to detail at Book Here is remarkable. The staff went above and beyond to make our anniversary special."
                                </div>
