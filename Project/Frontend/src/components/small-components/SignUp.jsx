    ...
    return (
        <>
            <div className="form-box signup pt-4" style={{ height: "43.03rem" }}>
                ...
                <form onSubmit={(e) => {
                    e.preventDefault();
                    props.handleSubmit([emailRef.current.value, passwordRef.current.value, nameRef.current.value])
                    ...
                    <div className="form-group w-75 mt-5 m-auto">
                        <div className="input-box">
                            <input type="text" id="signupName" required ref={nameRef} />
                        ...
                        <div className="text-center">
                            <input type="submit" value="Sign Up" className="btn w-100 py-2 btn-main-color" />
                        </div>
                        <div className="text-center mt-3">
                            <p>Already have an account? <Link className="links text-color" onClick={() => { props.setMode("login") }}>Sign in</Link></p>
                        </div>
                    </div>
                </form>
            </div>
